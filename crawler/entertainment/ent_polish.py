...
def generate_clickbait_title(selected_news):
    ...
    # 刺激性标题模板库（去掉具体日期，更具创意和普遍性）
    titles = [
        "【炸裂】娱乐圈惊天大瓜！这些反转你绝对猜不到",
        "【震撼】内幕全曝光！明星们的秘密藏不住了",
        "【爆料】黑幕重重？娱乐圈那些不为人知的故事",
        "【独家】全网热议！究竟是谁引爆了这场舆论风暴？",
        "【反转】剧情神展开！让人措手不及的娱乐圈大事",
        "【必看】瓜田大丰收！这次的瓜大到超乎想象",
        "【争议】欢喜还是忧愁？最具话题性的新闻全在这里",
        "【曝光】真相浮出水面！隐瞒已久的故事终于揭开",
        "【热议】全民围观！这到底是什么神仙剧情？",
        "【轰动】风波再起！众明星卷入，谁能独善其身？",
        "【惊掉下巴】娱乐圈魔幻现实主义大赏，编剧都不敢这么写",
        "【吃瓜一线】信息量巨大！这些细节你注意到了吗？"
    ]
    
    # 根据关键词选择最合适的标题
    if '婚变风波' in keywords:
        titles = [
            "【婚变】感情线崩盘！明星爱情童话为何碎了一地？",
            "【爆炸】分手官宣震撼全网！粉丝集体心碎现场",
            "【反转】爱恨情仇反转不断！这剧情比电视剧还精彩",
        ]
    elif '明星风波' in keywords:
        titles = [
            "【翻车】人设崩塌？争议不断的明星们经历了什么",
            "【风波】众怒难平！言行不当引发的舆论海啸",
            "【热议】往事被扒底裤不剩？网友吵翻天的真相",
        ]
...
请按照以下要求：
1. 选出 9 条新闻，它们必须与【历史记录】中的每一条都完全不同（如果是同一明星的同一事件，视为重复）
2. 这9条新闻之间也应该互不重复
3. 优先选择不同来源的新闻
